...
class TestKauppa(unittest.TestCase):
    ...
    def test_lisataan_kaksi_eri_tuotetta_joista_toinen_loppu(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_aloita_asiointi_toimii_oikein(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tilinumeron_pyynto_toimii_oikein(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
